	...
	return (
		<div className='max-w-6xl mx-auto'>
			...
			<h1 className='text-center text-4xl font-creteRound'>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error recusandae harum ullam repellat cum? Nisi unde,
				<br /> incidunt natus ut ratione dolore quasi at dolores molestia
			</h1>
			...
			<h2 className='text-center text-4xl section-title font-creteRound my-12'>
				<span>Bizning Professorlarimiz</span>
			</h2>
