...
export const navLinks = [
	{ name: 'Asosiy sahifa', route: '/', icon: Home },
	{ name: 'Biz haqimizda', route: '/about', icon: ListCollapse },
	{ name: 'Yangiliklar', route: '/blogs', icon: FileCode2 },
	{ name: 'Fanlar', route: '/blogs/archive', icon: FolderArchive },
	{ name: 'Aloqa', route: '/contact', icon: Contact2 },
]
...
export const authors = [
	{
		name: 'Begmatov Doston',
		image: '/author/chris-impey.jpg',
	},
	{
		name: "Abdulla Mo'minov",
...
export const fanlar = [
	...
	{
		title: 'EAxborot texnologiyalari',
		description:
			'In the wake of Facebook rebranding as Meta, reflecting its focus on the “metaverse”, Microsoft has now announced it, too, will launch into this.',
